...
public class FahrtD {
	...
	public FahrtD(String anbieter, String fahrdatumunduhrzeit, String von, String nach, int anzahlfreieplaetze,
			int fahrtkosten, String status, String beschreibung) {
		super();
